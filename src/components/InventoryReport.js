...
class InventoryReport extends Component {
  // we are working on the Today date
...
//   }
  ...
  constructor(props) {
    ...
    const inv_date = Moment(new Date()).format("DD-MM-yyyy");
    this.initialState = {
      DataisLoaded: false,
      itemsData: {},
      options: {},
  ...
  calculateData(event) {
    ...
    fetch(process.env.REACT_APP_API_URL + "/items?" + queryParams, {
      ...
      .then((response) => {
        ...
        reportSummary["Total Price"] =
          response.meta.aggregations.total_sum.slice(0, -3);
        reportSummary["Average Price"] =
          response.meta.aggregations.average.slice(0, -3);
        this.setState({
  ...
  render() {
    ...
    let noRecords = Object.values(this.state.itemsData).every(
    ...
    return (
      <div className="row justify-content-start border-secondary">
        ...
        <button onClick={"handleCollapsable"}>
          collapsable
              ...
              {Object.entries(this.state.reportSummary).map(([key, value]) => {
                return (
                  <div className="col-xxl-4 col-md-6">
                    <div
                      className={
                        "card info-card " + ICON_HASH_FOR_SUMMERY[key][1]
                      }
                    >
                      <div className="card-body">
                        <h5 className="card-title">
                          {key} <span>| Inventory</span>
                        </h5>
                        ...
                        >
                          <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                            <i
                              className={"bi " + ICON_HASH_FOR_SUMMERY[key][0]}
                            ></i>
                          </div>
                          <div className="ps-3">
                            <h6>{value}</h6>
                ...
                <div className="modal-content">
                  <div className="modal-header">
                    ...
                    <button
                      type="button"
                      className="btn-close"
                      onClick={this.handleHideDrillDown}
                    ></button>
                  </div>
                  <div className="modal-body">
                    <div className="row">
                      {Object.entries(this.state.reportSummary).map(
                        ([key, value]) => {
                          return (
                            <div className="col-xxl-4 col-md-6">
                              <div
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="d-flex align-items-center">
                                    <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                      <i
                                        className={
                                          "bi " + ICON_HASH_FOR_SUMMERY[key][0]
                                        }
                                      ></i>
                                    </div>
                                    <div className="ps-3">
        ...
        {noRecords ? null : (
          <div className="pagetitle text-center">
            <h1>Inventory Break Down {this.state.inventory_date}</h1>
            <br></br>
          </div>
        )}
        {noRecords ? null : (
